...
class Simplify_02(MacroSpec):
    name: str = "Simplify_02"
    projectName: str = "andre_spatial_09"
    category: str = "Spatial"
    minNumOfInputPorts: int = 1
    
    @dataclass(frozen=True)
    class Simplify_02Properties(MacroProperties):
    ...
    def dialog(self) -> Dialog:
        return Dialog("Simplify_02").addElement(
    ...
    def apply(self, props: Simplify_02Properties) -> str:
        # Get the table name
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return Simplify_02.Simplify_02Properties(
